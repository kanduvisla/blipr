...
TARGET = build/blipr
SRCS = main.c drawing.c drawing_utils.c drawing_components.c drawing_text.c drawing_icons.c colors.c file_handling.c project.c programs/sequencer.c programs/track_selection.c
OBJS = $(SRCS:.c=.o)
